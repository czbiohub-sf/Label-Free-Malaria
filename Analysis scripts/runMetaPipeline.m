% runMetaPipeline is a cell script intended to be run one cell at a time.
...
pipelineOptionsPath = 'C:\Users\SingleCellPicker\Documents\Temp data analysis\UVScope\metaPipelineSettings.json';
baseRawDataPath = 'G:\My Drive\UV Scope\Malaria Paper\Data\UV Scope\Raw data\Multi Color\';
baseOutputPath = 'C:\Users\SingleCellPicker\Documents\Temp data analysis\UVScope\';

% rawDataID identifying healthy control dataset
healthyDataset = 'UVM-2020-01-08-11-56-54 Healthy Control';
...
%% 2. Define the MetaPipeline object and pre-process data
...
% coarse-graining, for all wavelengths
for i=1:myMeta.nChannels
    myMeta.trainedClassifier{i}.plotConfidenceThresholding([],[],[],[]);
    myMeta.trainedClassifier{i}.plotConfidenceThresholding([],[],[],[],cg);
    myMeta.trainedClassifier{i}.plotConfidenceThresholding([],[],[],[],cg2);
    
    myMeta.trainedClassifier{i}.plotConfidenceStatistics();
    myMeta.trainedClassifier{i}.plotConfidenceStatistics([],[],[],[],cg);
    myMeta.trainedClassifier{i}.plotConfidenceStatistics([],[],[],[],cg2);
    
    myMeta.trainedClassifier{i}.computeStats();
    myMeta.trainedClassifier{i}.computeStats([],[],cg);
    myMeta.trainedClassifier{i}.computeStats([],[],cg2);
end
